  ...
  <section class="sprite-collection">
    ...
    <div v-else class="sprite-collection__container">
      <div class="sprite-collection__sprites">
        <div v-for="sprite in spritesSplit.firstHalf" :key="sprite" class="sprite-collection__sprite">
          <img :src="sprite" alt="sprite">
        </div>
      </div>
      <div class="sprite-collection__sprites">
        <div v-for="sprite in spritesSplit.secondHalf" :key="sprite" class="sprite-collection__sprite">
          <img :src="sprite" alt="sprite">
        </div>
      </div>
    </div>
